                ...
                <Accordion allowToggle>
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4} mt={3} color={"#666666"}>
                            <ul>
                                <li style={{fontSize: "18px"}}><strong>Astronomi ve Gökyüzü Gözlemleri: </strong> Teleskop kullanımı, yıldız haritaları, gezegenler ve gök cisimleri hakkında uygulamalı bilgiler.</li>
                                <li style={{fontSize: "18px"}}><strong> Roket Tasarımı ve Fırlatma Simülasyonları:</strong> Öğrenciler, kendi roketlerini tasarlayarak fizik ve mühendislik ilkelerini öğrenirler</li>
                                <li style={{fontSize: "18px"}}><strong> Robotik ve Kodlama:</strong> Uzay teknolojilerinde kullanılan robotik sistemlerin temelleri ve programlanması.</li>
                                <li style={{fontSize: "18px"}}><strong> Astronot Eğitimi Simülasyonları:</strong> Gerçek astronotların eğitim süreçlerinin simüle edildiği interaktif uygulamalar.</li>
                            </ul>
                        </AccordionPanel>
                    </AccordionItem>
                </Accordion>
